 ...
 * Handles API endpoints for ticket system management
 */
...
router.get('/servers/:serverId/tickets', async (req, res) => {
  try {
    ...
    const tickets = await ticketManager.getServerTickets(serverId);
...
router.post('/servers/:serverId/ticket-config', async (req, res) => {
  try {
    ...
    await ticketManager.saveServerConfig(serverId, config);
...
router.post('/servers/:serverId/ticket-panel', async (req, res) => {
  try {
    ...
    await ticketManager.sendTicketPanel(serverId, panelData);
...
router.get('/servers/:serverId/tickets/:ticketId', async (req, res) => {
  try {
    ...
    // Get ticket details
    const ticket = await ticketManager.getTicket(serverId, ticketId);
...
router.post('/servers/:serverId/tickets/:ticketId/close', async (req, res) => {
  try {
    ...
    // Close ticket
    await ticketManager.closeTicketById(serverId, ticketId, {
      reason,
...
router.get('/servers/:serverId/tickets/:ticketId/transcript', async (req, res) => {
  try {
    ...
    const transcript = await ticketManager.getTicketTranscript(serverId, ticketId);
