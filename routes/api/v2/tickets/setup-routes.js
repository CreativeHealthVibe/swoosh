...
// Helper function to get the ticket manager
function getTicketManager(req) {
  const client = getClient(req);
  return client ? client.ticketManager : null;
}

// Helper function to get the bounty manager
function getBountyManager(req) {
  const client = getClient(req);
  return client ? client.bountyManager : null;
}
